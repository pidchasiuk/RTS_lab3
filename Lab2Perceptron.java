...
public class Lab2Perceptron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int P = 4;
        final int[][] pointsArr = {{1, 5}, {3, 4}, {2, 3}, {2, 4}};
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double[] result = pеrceptron(P, pointsArr, sigma, t, iter);
                String res;
                res = "w1=" + result[0] + "\n";
                res += "w2=" + result[1] + "\n";
    ...
    public static double[] perceptron(int P, int[][] points, double sigma, long time, int iter) {
        double delta, y, w1 = 0, w2 = 0;
        int j = 0;
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Lab2Perceptron.this, MainActivity.class);
